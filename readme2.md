...
<body>
    <div class="container">
        <div class="header">
            <h1>🔬 Salivary Gland Diagnostic Support Tool</h1>
        ...
        <div class="main-disclaimer">
            <strong>⚠️ STRUMENTO DI SUPPORTO DECISIONALE</strong>
            ...
            La responsabilità diagnostica rimane del patologo.
        </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 14px; font-weight: 600; color: #2d3748; margin: 10px 0;">
                Il tool modella il ragionamento, non la biologia.
            </p>
            <p style="font-size: 12px; color: #4a5568; margin: 8px 0;">
    ...
    <script>
        ...
        const tumorDatabase = {
            ...
            ACC: {
                ...
                weights: {
                    ...
                    lef1: { pos: -5, neg: 3 },
                    cd117: { pos: 3, neg: -1 },
                    bcl2: { pos: 1, neg: 0 }, // Marker addizionale debole per ACC
                    sox10: { pos: 3, neg: -2 },
                    myb: { pos: 5, neg: -1 }
                }
            },
            MEC: {
                ...
                weights: {
                    ...
                    mucousCells: { abundant: 4, scarce: -1 }, // AUMENTATO: +3 → +4 (cellule mucose patognomoniche)
                    cysticComponent: { prominent: 2, minimal: 0 },
                    necrosis: { no: 0, yes: 2 },
                    pni: { no: 0, yes: 3 },
                    ki67: { low: 0, borderline: 0, high: 1, veryHigh: 2 },
                    maml2: { pos: 5, neg: 0 },
                    p63: { pos: 3, neg: -1 }, // AUMENTATO: +2 → +3
                    ck5_6: { pos: 4, neg: -1 } // AUMENTATO: +3 → +4
                }
            },
            AciCC: {
        ...
        const gradingSystems = {
            ...
            MEC: {
                ...
                parameters: [
                    ...
                    { id: "mec_mitoses", label: "≥4 mitosi/10 HPF", points: 3 },
                ...
                calculateGrade: function(totalPoints) {
                    ...
                    return { grade: "High", description: "Alto grado (≥7 punti)", prognosis: "Sfavorevole" };
                }
            },
            CaExPA: {
                ...
                calculateGrade: function(invasionMm) {
                    if (invasionMm <= 1.5) return { 
                        ...
                        description: "Invasione ≤1.5mm oltre la capsula",
        ...
        function validateStep() {
            ...
            if (currentStep === 3) {
                ...
                if (!pattern) {
                    alert('⚠️ Seleziona almeno un pattern morfologico');
                    return false;
                }
            }
            return true;
        ...
        function calculateAllScores() {
            ...
            for (const [tumorKey, tumor] of Object.entries(tumorDatabase)) {
                ...
                if (weights.ki67 && formData.ki67) {
                    ...
                    if (ki67Val <= 10) {
                        ki67Category = 'low';
                        ki67Text = 'compatibile con benignità';
                    } else if (ki67Val <= 20) {
                        ki67Category = 'borderline';
                        ki67Text = 'zona grigia, non discriminante';
                    } else if (ki67Val <= 30) {
                        ki67Category = 'high';
                        ki67Text = 'suggestivo malignità';
                    } else {
                    ...
                    if (ki67Weight && ki67Weight !== 0) {
                        ...
                        rationales[tumorKey].push({
                            text: `Ki-67: ${formData.ki67}% (${ki67Text}) ⚠️ parametro instabile`,
        ...
        function computeResults() {
            ...
            for (const [tumorKey, score] of Object.entries(scores)) {
                ...
                // TIER 1: Marker patognomonico → MOLECULAR anche con score basso
                if (hasPathognomonicMarker && normalizedScore >= 5) {
                    confidence = 'molecular';
                }
                // TIER 2: Marker supportivo → MOLECULAR solo se score morfologico solido
                ...
                if (tumorKey === 'MEC') {
                    ...
                    // Grading solo se: pattern mucoepidermoid O score MEC ≥8 (MEC effettivamente in DDx)
                    if (formData.pattern === 'mucoepidermoid' || (mecPoints > 0 && normalizedScore >= 8)) {
        ...
        function generateTextReport() {
            ...
            report += `⚠️ NOTA EPISTEMOLOGICA:\n`;
            report += `Questo output descrive la coerenza interna dei dati inseriti,\n`;
            report += `non la realtà biologica del tumore.\n\n`;
            ...
            if (formData.priorPA === 'yes') report += `⚠️ Storia di PA pregresso: SÌ\n`;
            report += `\n`;
            ...
            report += `Infiltrazione perineurale: ${formData.pni === 'yes' ? 'PRESENTE ⚠️' : (formData.pni === 'no' ? 'Assente' : 'N/D')}\n`;
            ...
            results.slice(0, 5).forEach((r, i) => {
                ...
                r.rationale.slice(0, 5).forEach(rat => {
                    const symbol = rat.type === 'positive' ? '✓' : (rat.type === 'negative' ? '✗' : '•');
            ...
            report += `DISCLAIMER\n`;
            report += `════════════════════════════════════════════════════════════════\n`;
            report += `Questo report è generato da uno strumento di SUPPORTO diagnostico.\n`;
            ...
            report += `La responsabilità diagnostica rimane del patologo.\n`;
            report += `════════════════════════════════════════════════════════════════\n`;
        ...
        function render() {
            ...
            if (currentStep === 1) {
                html = `
                    <div class="step active">
                        ...
                        <h4>⚠️ Red Flags per Carcinoma ex-PA</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label>
                                    ...
                                    Sì (incremento significativo negli ultimi mesi)
                                </label>
                                <label>
                        ...
                        <div class="critical-box" id="caexpaWarning" style="display: none; margin-top: 15px;">
                            <strong>⚠️ IMPORTANTE: Ca ex-PA in biopsia</strong><br>
                            ...
                            In biopsia è possibile solo sospetto morfologico. Il tool applicherà un penalty score.
                        </div>
                        
                        <div class="buttons">
                            <button class="btn-secondary" disabled>← Indietro</button>
                            <button class="btn-primary" onclick="nextStep()">Avanti →</button>
                        </div>
                    </div>
                `;
            }
            ...
            // ==================== STEP 2: Malignancy Criteria ====================
                ...
                html = `
                    <div class="step active">
                        <h3>Step 2/${totalSteps}: Criteri di Malignità</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                ...
                                <label style="background: #fff5f5;">
                                    ...
                                    <div>
                                        <strong style="color: #c53030;">⚠️ PRESENTE</strong><br>
                                        <small>Forte indicatore di malignità, tipico di ACC</small>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small style="color: #718096;">≥4 mitosi/10HPF suggestivo di malignità in MEC</small>
                        </div>
                        
                        <div class="critical-box">
                            <strong>Nota:</strong> L'infiltrazione perineurale è il singolo parametro più predittivo 
                            per ACC. La sua presenza deve sempre far sospettare malignità anche in contesti 
                            morfologicamente blandi.
                        </div>
                        
                        <div class="buttons">
                            <button class="btn-secondary" onclick="prevStep()">← Indietro</button>
                            <button class="btn-primary" onclick="nextStep()">Avanti →</button>
                        </div>
                    </div>
                `;
                    ...
                    <div class="step active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="info-box" style="margin-top: 10px;">
                                ...
                                • Pattern I: solido &lt;30% → Prognosi migliore<br>
                                • Pattern II: solido 30-70% → Intermedia<br>
                                • Pattern III: solido &gt;70% → Prognosi peggiore
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label>
                                    ...
                                    Sì (aree mixoidi/condroidi benigne residue)
                                </label>
                                <label>
                    ...
                    <div class="step active">
                        ...
                        <div class="ihc-grid">
                            <div class="ihc-section">
                                ...
                                <div class="info-box" style="margin-top: 10px; font-size: 11px;">
                                    ...
                                    • <strong>Intatto:</strong> p63+, SMA+, Calponina+ diffusi → PA favorito (+4)<br>
                                    • <strong>Parziale-PA:</strong> 2/3 positivi o focali → PA probabile (+2)<br>
                                    • <strong>Indeterminato:</strong> Pattern confuso, discordante → neutro (0)<br>
                                    • <strong>Parziale-ACC:</strong> p63 scarso/perso, SMA residua → ACC probabile (-2)<br>
                                    • <strong>Perso:</strong> Tutti negativi → ACC favorito (-4)
                                </div>
                            </div>
                            
                            <div class="ihc-section">
                                <h5>🔬 Marcatori Generali</h5>
                                <table>
                                    <thead>
                                        <tr>
                                            <th>Marcatore</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <strong>CK7</strong>
                                                <span style="font-size: 10px; color: #718096;" title="Marker pan-epiteliale con basso potere discriminante (positivo in SDC, MEC, PA; negativo in ACC, Warthin). Peso limitato nello scoring, rilevante principalmente per SDC."> ℹ️</span>
                                            </td>
                        ...
                        <div class="form-group" style="margin-top: 25px;">
                            ...
                            <div class="warning-box" style="margin-top: 10px;">
                                <strong>⚠️ Ki-67: parametro instabile (v4.1)</strong><br>
                                • ≤10% → Compatibile con benignità<br>
                                • 10-20% → Zona grigia (non discriminante)<br>
                                • &gt;20% → Sospetto per malignità<br>
                                <br>
                                <strong style="color: #c05621;">Nota critica:</strong> Hot spot selection, tecnica IHC e clone anticorpale 
                                influenzano pesantemente il risultato. PA cellulati possono raggiungere 15-20% senza malignità.
                        ...
                        <div class="ihc-grid">
                            <div class="ihc-section">
                                    ...
                                    <tbody>
                                        <tr style="background: #f0fff4;">
                                            <td>
                                                ...
                                                <small style="color: #276749;">⭐ Key discriminant</small>
                                            </td>
                                ...
                                <div class="success-box" style="margin-top: 10px; font-size: 11px;">
                                    ...
                                    LEF1 è virtualmente ASSENTE in ACC.<br>
                                    Sensibilità >95% per escludere ACC.
                                </div>
                            </div>
            ...
            // ==================== STEP 6: Molecular ====================
                ...
                html = `
                    <div class="step active">
                        ...
                        <div class="critical-box">
                            <strong>⚠️ Nota importante:</strong> Un risultato negativo NON esclude la diagnosi. 
                        ...
                        <div class="info-box">
                            ...
                            1. ETV6-NTRK3+ → MASC (patognomonico)<br>
                            2. MYB-NFIB+ → ACC (~80%)<br>
                            3. NR4A3+ → Carcinoma acinare<br>
                            4. PLAG1+ o HMGA2+ → PA<br>
                            5. MAML2+ → MEC (50-70%, prognosticamente favorevole)
                        </div>
                ...
                html = `
                    <div class="step active">
                        ...
                        <div class="grading-box">
                            <h4>📊 Grading MEC (Sistema AFIP/Brandwein)</h4>
                            ...
                            <div class="info-box" style="margin-top: 15px;">
                                ...
                                • 0-4 punti: Basso grado → Prognosi eccellente<br>
                                • 5-6 punti: Grado intermedio → Prognosi intermedia<br>
                                • ≥7 punti: Alto grado → Prognosi sfavorevole
                            </div>
                        </div>
                        
                        <div class="grading-box" style="margin-top: 25px;">
                            <h4>📏 Invasione Ca ex-PA (WHO 2022)</h4>
                            <p style="margin-bottom: 15px; color: #553c9a;">
                            ...
                            <div class="info-box">
                                ...
                                • ≤1.5mm: Minimamente invasivo → Prognosi eccellente (simile a PA)<br>
                                • 1.5-4mm: Invasivo → Prognosi intermedia<br>
                                • &gt;4mm: Ampiamente invasivo → Prognosi riservata
                            </div>
                        </div>
                ...
                html = `
                    <div class="step active">
                        ...
                        <div class="info-box">
                            ...
                            • Durata della lesione e pattern di crescita<br>
                            • Sintomi neurologici (paralisi facciale = red flag)<br>
                            • Dolore (raro nei benigni)<br>
                            • Precedenti interventi o biopsie<br>
                            • Imaging (cisti? captazione?)<br>
                            • Bilateralità (tipica Warthin)
                        </div>
                        
                        <div class="buttons">
                            <button class="btn-secondary" onclick="prevStep()">← Indietro</button>
                            <button class="btn-primary" onclick="nextStep()">📊 Visualizza Risultati →</button>
                        </div>
                    </div>
                `;
            }
                    ...
                    if (isMatch) {
                        concordanceHTML = `
                            <div class="success-box">
                                <strong>✅ CONCORDANZA CLINICO-PATOLOGICA</strong><br>
                        ...
                        concordanceHTML = `
                            <div class="warning-box">
                                <strong>⚠️ DISCORDANZA</strong><br>
                                Sospetto clinico "${formData.clinicalSuspicion}" non corrisponde alla diagnosi più probabile (${results[0]?.name}).<br>
                ...
                if (results[0]?.closeScoresWarning) {
                    ...
                    closeScoresHTML = `
                        <div class="warning-box" style="margin-bottom: 20px;">
                            <strong>⚠️ SCORE RAVVICINATI</strong><br>
                            La differenza tra <strong>${w.top1}</strong> 
                            e <strong>${w.top2}</strong> è solo di 
                    ...
                    <div class="step active">
                        ...
                        ${formData.specimenType === 'fnab' ? `
                            <div class="critical-box" style="margin-bottom: 20px;">
                                <strong>⚠️ CAMPIONE CITOLOGICO (FNAB)</strong><br>
                        ...
                        <div class="info-box" style="margin-bottom: 20px;">
                            <strong>📊 Come interpretare gli score (v4.1):</strong><br>
                            Lo score riflette la somma pesata dei criteri morfologici, IHC e molecolari inseriti.
                            <strong>Non è una probabilità diagnostica assoluta</strong>, ma un indice di compatibilità 
                            con i dati forniti. Score simili richiedono integrazione con dati aggiuntivi.
                            <br><br>
                            <strong>Confidence "MOLECULAR" (sistema a 2 tier):</strong><br>
                            • <strong>Tier 1 - Marker patognomonici</strong> (ETV6-NTRK3, MYB-NFIB, NR4A3): 
                            confidence molecular se score <strong>≥5</strong> 
                            <span style="font-size: 11px; color: #2c5282;">(marker patognomonico in contesto morfologico almeno compatibile)</span><br>
                            • <strong>Tier 2 - Marker supportivi</strong> (PLAG1, HMGA2, MAML2): 
                            confidence molecular se score <strong>≥10</strong> 
                            <span style="font-size: 11px; color: #2c5282;">(marker supportivo richiede morfologia solida)</span>
                            <br><br>
                        ...
                        <div class="warning-box" style="margin-bottom: 20px;">
                            <strong>⚠️ PATTERN NON CLASSIFICABILE?</strong><br>
                            Questo tool copre le <strong>8 entità più comuni</strong> (PA, ACC, MEC, AciCC, MASC, SDC, Warthin, Ca ex-PA).
                            <br><br>
                            Se la morfologia <strong>non si adatta a nessuna</strong> delle diagnosi proposte, considera entità rare:
                        ...
                        <div class="report-section">
                            <h4>📊 Ranking Diagnostico (click per dettagli)</h4>
                            ${results.length === 0 ? `
                                <div class="warning-box">
                                ...
                                <div class="diagnosis-card ${r.confidence}" onclick="this.classList.toggle('expanded')">
                                    <div class="header-row">
                                        ...
                                        <span class="confidence-badge ${r.confidence}">
                                            ${r.confidence === 'molecular' ? '🧬 MOLECULAR' : r.confidence.toUpperCase()}
                                        </span>
                                    </div>
                                    ...
                                    <div style="font-size: 9px; color: #cbd5e0; font-weight: 300;" title="Score comparativo interno (non lineare, non probabilistico). Riflette compatibilità relativa con i dati inseriti, NON certezza diagnostica. Valori assoluti non confrontabili tra casi diversi.">
                                        Score indicativo: ${r.score} ±2 <span style="opacity: 0.5;">| ${r.percentage}% max</span> ℹ️
                                        ${formData.specimenType === 'fnab' ? '<br><span style="color: #c53030; font-weight: 600;">⚠️ Calcolato su dati parziali (FNAB)</span>' : ''}
                                    </div>
                                    ${r.grading ? `
                        ...
                        <div class="report-section">
                            <h4>📋 Riepilogo Parametri Chiave</h4>
                            <table style="font-size: 12px;">
                                ...
                                <tr>
                                    ...
                                    <td>${formData.pni === 'yes' ? '⚠️ PRESENTE' : (formData.pni === 'no' ? 'Assente' : 'N/D')}</td>
                                </tr>
                                <tr>
                                    <td><strong>LEF1:</strong></td>
                                    <td>${formData.lef1 || 'N/D'}</td>
                                    <td><strong>MYB-NFIB:</strong></td>
                                    <td>${formData.myb === 'pos' ? '🧬 POSITIVO' : (formData.myb || 'N/D')}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="warning-box">
                            <strong>⚠️ Interpretazione:</strong> Questi risultati sono indicazioni probabilistiche basate sui parametri inseriti.
                            <strong>Questo output descrive la coerenza interna dei dati inseriti, non la realtà biologica del tumore.</strong>
                            La diagnosi finale richiede sempre integrazione con la morfologia HE completa, il pannello IHC, 
                            gli studi molecolari e la correlazione clinico-radiologica. La responsabilità diagnostica rimane del patologo.
                        </div>
